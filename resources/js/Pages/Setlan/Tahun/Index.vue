...
<template>
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <!-- Form Tambah Tahun -->
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6" v-if="can.create">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="tahun in daftarTahun" :key="tahun.id_tahun">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" v-if="can.delete">
